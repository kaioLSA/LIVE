...
const styles: Record<string, React.CSSProperties> = {
  ...
  experience: { position: 'absolute', top: -30, left: -30, background: '#8B2335', padding: '24px 20px', display: 'flex', alignItems: 'center', gap: 10 },
  expNumber: { fontFamily: "'Cormorant Garamond', serif", fontSize: '2.5rem', fontWeight: 700, color: '#fff', lineHeight: 1 },
  expText: { fontSize: '0.6rem', fontWeight: 700, letterSpacing: 2, color: 'rgba(255,255,255,0.85)', lineHeight: 1.4, whiteSpace: 'pre-line' as const },
